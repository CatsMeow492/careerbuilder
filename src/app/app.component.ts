...
const mockResponse = [
  {
    companyName: 'Software Development Analyst with Security Clearance',
    description: `
  ...
  {
    companyName: 'Technical Intern: Software Development jobs in ',
    description: `
  ...
  {
    companyName: 'Software Development Instructor - REMOTE',
    description: `
  ...
  {
    companyName: 'Software Engineer, Research and Development',
    description: `
  ...
  {
    companyName: '.NET Software Development Lead (Choice)',
    description: `
...
export class AppComponent {
  ...
  search() {
    ...
    this.http
      .get(
        'https://2yu0xpu560.execute-api.us-east-1.amazonaws.com/dev/board/companies',
        httpOptions
      )
      .subscribe((res: any) => {
